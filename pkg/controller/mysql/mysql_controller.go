...
import (
	...
	finupgroupv1beta1 "github.com/huangjiasingle/mysql-operator/pkg/apis/finupgroup/v1beta1"
...
// USER ACTION REQUIRED: update cmd/manager/main.go to call this finupgroup.Add(mgr) to install this Controller
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &finupgroupv1beta1.Mysql{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
	...
	err = c.Watch(&source.Kind{Type: &appsv1.Deployment{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &finupgroupv1beta1.Mysql{},
	})
	if err != nil {
		return err
	}
...
// +kubebuilder:rbac:groups=finupgroup.com,resources=mysqls,verbs=get;list;watch;create;update;patch;delete
func (r *ReconcileMysql) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	// Fetch the Mysql instance
	instance := &finupgroupv1beta1.Mysql{}
